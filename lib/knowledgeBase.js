...
const INTENTS = [
    ...
    },
    {
        ...
        intent: 'return_claim',
        patterns: [
            /\b(refund|return|money back|reimburse|exchange|replace)\b.*\b(broken|cracked|damaged|defect|defective|torn|peel|missing|label|seal|wrong|not working|expired|stale|leaking|size|fit)\b/i,
            /\b(broken|cracked|damaged|defect|defective|torn|wrong size|wrong item|not working|expired|leaking)\b.*\b(refund|return|money back|exchange|replace)\b/i,
            /\bi (want|need|would like) (a|to) (refund|return|exchange|replace|money back)\b/i,
        ],
        answer: null,
    },
    {
