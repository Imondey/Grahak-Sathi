      ...
      <div style={{ position: 'relative', zIndex: 1, minHeight: '100vh', fontFamily: "'Sora', sans-serif" }}>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <button onClick={() => navigate('/purchases')} style={{ padding: '6px 14px', borderRadius: 20, fontSize: 11, fontWeight: 600, background: 'transparent', border: '1px solid rgba(109,40,217,.3)', color: '#6d28d9', cursor: 'pointer' }}>🧾 Purchases</button>
